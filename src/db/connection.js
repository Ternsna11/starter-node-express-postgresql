...
// const env = process.env.NODE_ENV || "development"; determines the current environment where the application code is running and stores the value in the env variable. If process.env.NODE_ENV is not defined, then set the value to "development".
